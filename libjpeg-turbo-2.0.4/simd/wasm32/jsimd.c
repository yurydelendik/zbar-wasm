...
jsimd_ycc_rgb565_convert(j_decompress_ptr cinfo, JSAMPIMAGE input_buf,
                         ...
                         int num_rows)
{
  jsimd_ycc_rgb565_convert_wasm(cinfo->output_width, input_buf, input_row,
                                output_buf, num_rows);
}
...
jsimd_h2v1_fancy_upsample(j_decompress_ptr cinfo, jpeg_component_info *compptr,
                          JSAMPARRAY input_data, JSAMPARRAY *output_data_ptr)
{
  jsimd_h2v1_fancy_upsample_wasm(cinfo->max_v_samp_factor,
...
{
  jsimd_idct_2x2_wasm(compptr->dct_table, coef_block, output_buf, output_col);
}
...
jsimd_idct_4x4(j_decompress_ptr cinfo, jpeg_component_info *compptr,
               ...
               JDIMENSION output_col)
{
  jsimd_idct_4x4_wasm(compptr->dct_table, coef_block, output_buf, output_col);
}
...
jsimd_idct_ifast(j_decompress_ptr cinfo, jpeg_component_info *compptr,
                 ...
                 JDIMENSION output_col)
{
  jsimd_idct_ifast_wasm(compptr->dct_table, coef_block, output_buf,
                        output_col);
}
