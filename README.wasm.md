...
```
$WASI_PREFIX/bin/clang decode_jpeg.c -o decode_jpeg.wasm -Ilibjpeg-turbo-2.0.4/ -Izbar-0.10/include zbar-0.10/zbar/.libs/libzbar.a libjpeg-turbo-2.0.4/libjpeg.a
wasmtime run --disable-cache --mapdir .::$PWD decode_jpeg.wasm
